...
import { Plus, Search, MapPin, Phone, Mail, Users, Clock, Building2, Edit, Trash2, Eye, Download, MoreHorizontal,ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight , Play, Pause} from 'lucide-react'
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {branches.reduce(
                  (total, branch) => total + branch.staffs.length,
                  0
                )}
              </div>
              <p className="text-xs text-muted-foreground">
                    ...
                    <TableHead>
                      <input
                        ...
                        checked={
                          branches.length > 0 &&
                          branches.every((b) =>
                            selectedIds.includes(b.branchId)
                          )
                        }
                      />
                    </TableHead>
                      ...
                      <TableCell>
                        <div className="text-sm space-y-1">
                          <div className="flex items-center gap-1">
                            ...
                            {branchService.getActiveServicesCount(
                              branch.services
                            )}{" "}
                            active
                          </div>
                      ...
                      <TableCell>
                        <div className="text-sm">
                          <div className="flex items-center gap-1">
                            ...
                            {branchService.getActiveStaffCount(
                              branch.staffs
                            )}{" "}
                            active
                          </div>
                      ...
                      <TableCell>
                        <div className="text-sm">
                          <div className="flex items-center gap-1">
                            ...
                            {branchService.getOpenDaysCount(
                            ...
                            {branch.operatingHours
                              ...
                              .map((hours) => (
                                <div key={hours.dayOfWeek}>
                                  {branchService.getDayName(hours.dayOfWeek)}:{" "}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              branch(es)? This action cannot be undone.
            </p>
